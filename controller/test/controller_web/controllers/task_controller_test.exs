defmodule ControllerWeb.TaskControllerTest do
  ...
  @create_attrs %{
    desired_value: 120.5,
    scheduled_at: ~T[14:00:00]
  }
  @update_attrs %{
    desired_value: 456.7,
    scheduled_at: ~T[15:01:01]
  }
  @invalid_attrs %{desired_value: nil, scheduled_at: nil}
